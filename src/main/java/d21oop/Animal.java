...
*/
    ...
    Child class'ının eat metodunun, Parent class'ının eat metodundan
     daha az erişilebilir olmasından kaynaklanır.
    */
    //------------------
    ...
    public Number multiply (Integer a , Integer b){
        return a * b ;//parenttaki her zaman daha üst class olmalı ıntegerın üstü Number
    }
