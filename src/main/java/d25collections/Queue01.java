...
public class Queue01 {
    ...
    Queue interface'i, LinkedList ve PriorityQueue gibi farklı class'lar tarafından uygulanabilir.*/
        ...
        System.out.println(storage);//[sut, et, yumurta, peynir] insrtion order
        ...
        //System.out.println(storage.element());kuyruk boş olduğu için hata veriyor
        ...
        emergencyQueue.add("Kağan");
        emergencyQueue.add("Hazar");
        emergencyQueue.add("Ali");
        System.out.println(emergencyQueue);//[Ali, Hazar, Mehmet, Seval, Kağan]
        ...
        //sıralama ve depolama mantığı constructor tarafından gelir constructor Linkedlist olduğu için insert sıralaması oldu
