...
public class Lambda01 {
    ...
    //t -> akistan gelen her bir t degeri icin  //akıstan gelen her bir t (data) icin
    ...
    //Example 4: Find all even numbers in a List<Integer> and write a method that prints these numbers to the console on the same line,
    // with a space between them.(functional)
