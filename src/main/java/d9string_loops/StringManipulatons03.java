...
public class StringManipulatons03 {
    public static void main(String[] args) {
        ...
        System.out.println(first);// hiçlik var ise true içinde a boşluk var ise false çıkar sonuç
        ...
        if (second){
            System.out.println("Parola boş bırakılmamalı");
        }
